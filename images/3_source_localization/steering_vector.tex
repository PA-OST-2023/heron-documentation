...
%    \draw[style=help lines,step=0.5cm] (-4,-4) grid (4,4);
    ...
    \foreach \i in {0,...,4}
    {
        ...
        \draw[black,name intersections={of=line and mLine,by={Int1}}, ->] (\i * 360/\b:\rrr) -- (Int1)
            node[midway,left]{$\bm{d}_\i(\varphi_s)$};
