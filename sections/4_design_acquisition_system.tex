...
To test the four evaluated microphone types, a carrier \acrshort{pcb} was designed and manufactured.
...
Each breakout board is separated by a V-groove, a common technique used in \acrshort{pcb} manufacturing.
This allows the individual breakout boards to be easily separated from each other.
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/4_design_acquisition_system/Microphone_Boards_Front.png}
...
This connector type is commonly found in \gls{adafruit} \textit{STEMMA QT / Qwiic JST} \acrshort{i2c}-Sensor boards.
