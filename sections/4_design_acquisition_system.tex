...
\begin{enumerate}
	...
	\item \textbf{Ethernet Port}: An RJ45 ethernet port was incorporated for future development opportunities, such as streaming audio data over ethernet.
	\item \textbf{Touch LCD Display}: A touch \acrshort{tft} display was integrated to offer an easy-to-use \acrshort{ui}, facilitating efficient system configuration, operation, and real-time monitoring.
...
Although a variety of microphone technologies such as condenser, dynamic, and electret are available, the focus has been set on \acrshort{mems} microphones due to several compelling reasons.
...
All four microphone types are available in large quantities at \textit{JLC-PCB}, a popular \acrshort{pcb} manufacturer.
Comparing the datasheets of the different microphones, only small differences in the specifications were found.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10.0cm]{images/4_design_acquisition_system/Microphone_Boards_Front.png}
