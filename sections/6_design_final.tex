...
Only a few additional components were soldered by hand, such as the PDM to TDM converters (ADAU7118), the EtherCon connector and the GNSS module (NEO-M8P-2).
