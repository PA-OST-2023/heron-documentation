...
\begin{minipage}{\linewidth}
	...
	\end{wrapfigure}
	This array geometry allows to build circular arrays with different radiuses.
	Additionally the adaptation of the underbrink array can be made. The orange points
	show such a configuration.
	A second one, where each circle is shifted by $\pi / 8$ rad is also possible.
\end{minipage}
