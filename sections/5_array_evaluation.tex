...
In practice, a maximal outer diamater of 60\,cm was chosen for the array prototypes.
...
\todo[inline]{cite Circ array drone trackings13638-019-1632-9} is using the ratio
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth, trim={0 4.9cm 0 0}]{images/5_array_evaluation/array_final_design_mechanical_dimensions.pdf}
